...
-   Resetowanie hasła: Mechanizm odzyskiwania dostępu do konta. Użytkownicy zostaną poinformowani o braku tej funkcji.
...
-   Acceptance Criteria:
    -   W widoku piosenki oraz repertuaru (w trybie zarządzania) znajduje się przycisk "Udostępnij".
