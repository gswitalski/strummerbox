...
-   FR-010a: Edytor piosenek udostępnia narzędzie do konwersji tekstu z formatu "akordy nad tekstem" do formatu ChordPro. Funkcjonalność jest dostępna poprzez dedykowane okno modalne i operuje w całości po stronie klienta, a przekonwertowany tekst jest dołączany do aktualnej treści piosenki.
